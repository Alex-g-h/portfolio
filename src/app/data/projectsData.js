export const ProjectsData = [
  {
    ...
    name: 'Snoop mini',
    description:
      'Snoop mini — мобильное приложение компаньон, предназначенное для работы с устройством обнаружения утечек сигналов Arcom Digital Snoop Mini. Приложение позволяет конфигурировать и управлять процессом обнаружения утечек сигналов в кабельной сети. ',
    link: {
